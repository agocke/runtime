...
for cfg in "${configs[@]}"; do
    ...
    dotnet build "$scriptroot/src/tools/BuildEquivalenceCheck/BuildEquivalenceCheck.csproj" \
        --nologo -v quiet 2>&1
    ...
    tool_args=(
        ...
        --managed-manifest "$scriptroot/src/tools/BuildEquivalenceCheck/managed-assembly-manifest.txt"
    )
    ...
    dotnet run --project "$scriptroot/src/tools/BuildEquivalenceCheck/BuildEquivalenceCheck.csproj" \
