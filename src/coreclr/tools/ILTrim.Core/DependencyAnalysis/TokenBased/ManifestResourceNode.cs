            ...
            if (resource.Implementation.IsNil)
            {
                ...
                if (resourceName == "ILLink.Descriptors.xml")
                {
                    ...
                    if (!factory.Settings.IgnoreDescriptors)
                    {
                        ...
                        dependencies.AddRange(DescriptorMarker.GetDependencies(factory.Logger, factory, ms, resource, _module, "resource " + resourceName + " in " + _module.ToString(), factory.Settings.FeatureSettings));
                    }
                }
            }
            else
