...
namespace ILCompiler.DependencyAnalysis
{
    ...
    public class ScannedMethodNode : DependencyNodeCore<NodeFactory>, IMethodBodyNode
    {
        ...
        public override void AddStaticDependencies(DependencySink<NodeFactory> sink, NodeFactory factory)
        {
            ...
            sink.AddRange(_dependencies); return;
        }

        public override void AddConditionalDependencies(DependencySink<NodeFactory> sink, NodeFactory factory) => sink.AddRange(_conditionalDependencies);
