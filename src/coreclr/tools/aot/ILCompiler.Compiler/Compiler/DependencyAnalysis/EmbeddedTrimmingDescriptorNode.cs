        ...
        public override void AddStaticDependencies(DependencySink<NodeFactory> sink, NodeFactory factory)
        {
            ...
            foreach (var resourceHandle in _module.MetadataReader.ManifestResources)
            {
                ...
                if (resourceName == "ILLink.Descriptors.xml")
                {
                    ...
                    sink.AddRange(DescriptorMarker.GetDependencies(metadataManager.Logger, factory, ms, resource, _module, "resource " + resourceName + " in " + _module.ToString(), metadataManager.FeatureSwitches)); return;
                }
            }
            return;
        }
