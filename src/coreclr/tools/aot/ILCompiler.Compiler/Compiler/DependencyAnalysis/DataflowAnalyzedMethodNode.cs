...
namespace ILCompiler.DependencyAnalysis
{
    ...
    public class DataflowAnalyzedMethodNode : DependencyNodeCore<NodeFactory>
    {
        ...
        public override void AddStaticDependencies(DependencySink<NodeFactory> sink, NodeFactory factory)
        {
            ...
            try
            {
                sink.AddRange(Dataflow.ReflectionMethodBodyScanner.ScanAndProcessReturnValue(factory, mdManager.FlowAnnotations, mdManager.Logger, _methodIL, out _runtimeDependencies)); return;
            }
