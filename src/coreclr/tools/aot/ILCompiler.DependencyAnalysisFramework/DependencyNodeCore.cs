...
namespace ILCompiler.DependencyAnalysisFramework
{
    public interface IDependencySink<DependencyContextType>
    {
        ...
        void AddRange(IEnumerable<DependencyNodeCore<DependencyContextType>.DependencyListEntry> dependencies);
    }
    ...
    public interface IConditionalDependencySink<DependencyContextType>
    {
        ...
        void AddRange(IEnumerable<DependencyNodeCore<DependencyContextType>.CombinedDependencyListEntry> dependencies);
    }
    ...
    public abstract class DependencyNodeCore<DependencyContextType> : DependencyNode, IDependencyNode<DependencyContextType>
    {
        ...
        public class DependencyList : List<DependencyListEntry>, IDependencySink<DependencyContextType>
        {
            ...
            public new virtual void AddRange(IEnumerable<DependencyListEntry> dependencies)
            {
                base.AddRange(dependencies);
            }
        }
        ...
        public class CombinedDependencyList : List<CombinedDependencyListEntry>, IConditionalDependencySink<DependencyContextType>
        {
            ...
            public new virtual void AddRange(IEnumerable<CombinedDependencyListEntry> dependencies)
            {
                base.AddRange(dependencies);
            }
        }
