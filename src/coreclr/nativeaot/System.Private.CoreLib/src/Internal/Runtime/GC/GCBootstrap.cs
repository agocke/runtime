...
namespace Internal.Runtime.GC
{
    internal unsafe struct GCBootstrap
    {
        ...
        private static void InitializeVtables()
        {
            ...
            s_heapVtable.GarbageCollect = &GCWksInitialization.GarbageCollect;
            ...
            s_heapVtable.GetCondemnedGeneration = &GCWksInitialization.GetCondemnedGeneration;
            s_heapVtable.IsGCInProgressHelper = &GCWksInitialization.IsGCInProgressHelper;
            s_heapVtable.GetGcCount = &GCWksInitialization.GetGcCount;
            ...
            s_heapVtable.WaitUntilGCComplete = &GCWksInitialization.WaitUntilGCComplete;
            s_heapVtable.FixAllocContext = &Stub_FixAllocContext;
            s_heapVtable.GetCurrentObjSize = &Stub_GetCurrentObjSize;
            s_heapVtable.SetGCInProgress = &GCWksInitialization.SetGCInProgress;
            s_heapVtable.RuntimeStructuresValid = &Stub_RuntimeStructuresValid;
            s_heapVtable.SetSuspensionPending = &GCWksInitialization.SetSuspensionPending;
            ...
            s_heapVtable.SetWaitForGCEvent = &GCWksInitialization.SetWaitForGCEvent;
            s_heapVtable.ResetWaitForGCEvent = &GCWksInitialization.ResetWaitForGCEvent;
