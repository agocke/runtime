...
GC_CONST(         8,         8, LARGE_REGION_FACTOR)
GC_CONST(  80000000,  80000000, region_alloc_free_bit)
GC_CONST(         1,         1, allocate_forward)
GC_CONST(  ffffffff,  ffffffff, allocate_backward)
GC_CONST(         0,         0, basic_free_region)
GC_CONST(         1,         1, large_free_region)
GC_CONST(         2,         2, count_distributed_free_region_kinds)
GC_CONST(         2,         2, huge_free_region)
GC_CONST(         3,         3, count_free_region_kinds)
GC_SIZEOF(         4,         4, allocate_direction)
...
GC_SIZEOF(        1c,        38, region_free_list)
GC_ALIGNOF(         4,         8, region_free_list)
#endif
