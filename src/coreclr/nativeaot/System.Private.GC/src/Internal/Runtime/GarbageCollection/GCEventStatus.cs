...
//
// GCEventStatus::DebugDumpState is deliberately not translated here. The commented-out
// TRACE_GC_EVENT_STATE define in the C++ header turns it on; it is an fprintf-based dump, and the
// managed GC has no string-free logging facility to write it with yet. The rest of the header,
// including FireDynamicEvent and the expanded gcevents.h table, is in GCEvents.cs.
//
