...
namespace System
{
    internal static partial class SR
    {
        ...
        /// <summary>Resolved assembly must be a runtime Assembly object.</summary>
        internal static string @InvalidOperation_ResolvedAssemblyMustBeRuntimeAssembly => GetResourceString("InvalidOperation_ResolvedAssemblyMustBeRuntimeAssembly");
        /// <summary>Resolved assembly's simple name must be the same as of the requested assembly.</summary>
        internal static string @InvalidOperation_ResolvedAssemblyRequestedNameMismatch => GetResourceString("InvalidOperation_ResolvedAssemblyRequestedNameMismatch");
        ...
        /// <summary>Generic type constraints do not match.</summary>
        internal static string @Argument_GenTypeConstraintsNotEqual => GetResourceString("Argument_GenTypeConstraintsNotEqual");
        /// <summary>Generic method constraints do not match.</summary>
        internal static string @Argument_GenMethodConstraintsNotEqual => GetResourceString("Argument_GenMethodConstraintsNotEqual");
        ...
        /// <summary>Calling built-in Equals() or GetHashCode() on type marked as InlineArray is invalid.</summary>
        internal static string @NotSupported_InlineArrayEqualsGetHashCode => GetResourceString("NotSupported_InlineArrayEqualsGetHashCode");
        ...
        /// <summary>COM target does not implement IDispatch.</summary>
        internal static string @TargetInvocation_TargetDoesNotImplementIDispatch => GetResourceString("TargetInvocation_TargetDoesNotImplementIDispatch");
        /// <summary>The interface does not support late bound calls since it does not derive from IDispatch.</summary>
        internal static string @TargetInvocation_InterfaceNotIDispatch => GetResourceString("TargetInvocation_InterfaceNotIDispatch");
        ...
        /// <summary>Emitting debug info is not supported for this member.</summary>
        internal static string @NotSupported_EmitDebugInfo => GetResourceString("NotSupported_EmitDebugInfo");
        /// <summary>The specified type must be a reference type, a primitive type, or an enum type.</summary>
        internal static string @NotSupported_ReferenceEnumOrPrimitiveTypeRequired => GetResourceString("NotSupported_ReferenceEnumOrPrimitiveTypeRequired");
        /// <summary>The field is invalid for initializing array or span.</summary>
        internal static string @Argument_BadFieldForInitializeArray => GetResourceString("Argument_BadFieldForInitializeArray");
        /// <summary>Only array or span of primitive or enum types can be initialized from static data.</summary>
        internal static string @Argument_BadArrayForInitializeArray => GetResourceString("Argument_BadArrayForInitializeArray");
        /// <summary>CriticalHandle derived types cannot be stored in Variants.</summary>
        internal static string @ComVariant_CriticalHandle_In_Variant => GetResourceString("ComVariant_CriticalHandle_In_Variant");
        /// <summary>SafeHandle derived types cannot be stored in Variants.</summary>
        internal static string @ComVariant_SafeHandle_In_Variant => GetResourceString("ComVariant_SafeHandle_In_Variant");
        /// <summary>Method's type signature is not Interop compatible.</summary>
        internal static string @ComVariant_UnsupportedSignature => GetResourceString("ComVariant_UnsupportedSignature");
        /// <summary>The method returned a COM Variant type that is not Interop compatible.</summary>
        internal static string @ComVariant_UnsupportedType => GetResourceString("ComVariant_UnsupportedType");
        /// <summary>VariantWrappers cannot be stored in Variants.</summary>
        internal static string @ComVariant_VariantWrapper_In_Variant => GetResourceString("ComVariant_VariantWrapper_In_Variant");
